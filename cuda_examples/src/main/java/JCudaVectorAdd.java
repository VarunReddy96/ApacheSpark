/* Instructions for testing this sample on the GPU cluster
To compile the kernel:
    nvcc -ptx JCudaVectorAddKernel.cu -o JCudaVectorAddKernel.ptx

To compile:
    javac -cp .:/usr/local/pub/ph/jcuda/jcuda-10.1.0.jar:/usr/local/pub/ph/jcuda/jcuda-natives-10.1.0.jar JCudaVectorAdd.java

To run:
    java -cp .:/usr/local/pub/ph/jcuda/jcuda-10.1.0.jar:/usr/local/pub/ph/jcuda/jcuda-natives-10.1.0-linux-x86_64.jar JCudaVectorAdd
